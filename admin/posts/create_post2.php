...
<script src="https://cdn.tiny.cloud/1/rck51mi04cpy5roh9085fgsp2gfw73arxds4lz7k8bs40sg0/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
	...
	<div class="container-fluid shadow-sm mt-5 mb-3" style="max-width: 1365.98px;">
      ...
      tinymce.init({
        selector: '#body'
                        ...
                        <h4>RRECLAMĂ</h4>
                        <br>
                        <div class="form-group" id="body_2">
