    ...
    <div class="container shadow mt-5 mb-3">
        <div class="row">
            <div class="col-sm-4 col-md-offset-4 mx-auto">
                ...
                <form class="form border p-2" action="normalUserForm.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <?php if ($isEditing === true): ?>
                            <button type="submit" name="update_normal_user" class="btn btn-success btn-block btn-lg">Actualizare Utilizator</button>
                        <?php else: ?>
                            <button type="submit" name="save_normal_user" class="btn btn-success btn-block btn-lg">Salvează Utilizator</button>
                        <?php endif; ?>
                    </div>
                </form>
                <br>
