...
if (isset($_GET['topic'])) {
    $topic_id = $_GET['topic'];
    $posts = getPublishedPostsByTopicPage3($topic_id);
}
?>
...
<div class="container-fluid shadow" style="max-width: 1599.98px;">
    ...
    font-weight: bold;">
	    ...
	    <div class="container">
	        <div class="row">
	            <?php
							$posts = getPublishedImagPage3($topic_id);
 ...
 <!-- Paginatie -->
    ...
    <li class="page-item active"><a class="page-link" href="<?php echo BASE_URL . 'filtered_posts_pg_3.php?topic=1'?>">3</a></li>
    <li class="page-item disabled"><a class="page-link" href="<?php echo BASE_URL . 'filtered_posts_pg_3.php?topic=1'?>">Ultima</a></li>
  </ul>
            <?php endif ?>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <a class="dropdown-item active" href="<?php echo BASE_URL . 'filtered_posts_pg_3.php?topic=2'?>">3</a>
    ...
    <li class="page-item active"><a class="page-link" href="<?php echo BASE_URL . 'filtered_posts_pg_3.php?topic=3'?>">3</a></li>
    <li class="page-item"><a class="page-link" href="<?php echo BASE_URL . 'filtered_posts_pg_3.php?topic=3'?>">Ultima</a></li>
  </ul>
            <?php endif ?>
    ...
    <li class="page-item active"><a class="page-link" href="<?php echo BASE_URL . 'filtered_posts_pg_3.php?topic=4'?>">3</a></li>
    <li class="page-item"><a class="page-link" href="<?php echo BASE_URL . 'filtered_posts_pg_3.php?topic=4'?>">Ultima</a></li>
  </ul>
            <?php endif ?>
