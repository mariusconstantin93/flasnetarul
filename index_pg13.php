...
<title>Flashnetarul - Toate articolele (pagina 13)</title>
...
<div class="container-fluid shadow mb-3 mt-4 bg-light" style="max-width: 1599.98px;">
    ...
    <div class="row">
        <div class="col-sm-9 p-4">
            ...
            <?php $posts = getPublishedPostsPg13(); ?>

            <div class="card bg-secondary text-white m-4 mb-3">
                <div class="card-body p-2 border-left border-warning rounded font-weight-bold">Toate articolele (pagina 13)</div>
            </div>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <a class="dropdown-item active" href="<?php echo BASE_URL . 'index_pg13.php'?>">13</a>
    ...
    <a class="dropdown-item" href="<?php echo BASE_URL . 'index_pg17.php'?>">17</a>
        ...
        <!--<li class="page-item ml-1 disabled"><a class="page-link" href="<?php echo BASE_URL . 'index_pg12.php'?>">Ultima</a></li>-->
    </ul>   
