<div class="jumbotron text-center py-2 px-0" style="margin-bottom:0">
    ...
    <!--<br>-->
    <!--<img class="img-fluid" src="https://i.imgur.com/vz8PQz8.png" width="80px">-->
    <!--<br>-->
...
<nav class="navbar navbar-expand-lg bg-dark navbar-dark sticky-top shadow-lg mb-2">
    ...
    <a class="navbar-brand p-0" href="<?php echo BASE_URL . 'index.php'?>"><img class="img-fluid" src="https://i.imgur.com/vz8PQz8.png" width="35px"></a>
...
<!--<script async src='https://cse.google.com/cse.js?cx=partner-pub-3710013425442678:9270068981'></script><div class="gcse-searchbox-only"></div>-->
<!--</div>-->
