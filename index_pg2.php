...
<title>Flashnetarul - Toate articolele (pagina 2)</title>
...
<div class="container-fluid shadow mb-3 mt-4 bg-light" style="max-width: 1599.98px;">
    ...
    <div class="row">
        <div class="col-sm-9 p-4">
            ...
            <?php $posts = getPublishedPostsPg2(); ?>

            <div class="card bg-secondary text-white m-4 mb-3">
                <div class="card-body p-2 border-left border-warning rounded font-weight-bold">Toate articolele (pagina 2)</div>
            </div>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <a class="dropdown-item active" href="<?php echo BASE_URL . 'index_pg2.php'?>">2</a>
